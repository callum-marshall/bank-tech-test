describe 'Transaction' do
  ...
  describe 'transaction attributes' do
    ...
    it 'stores the given type as an accessible attribute' do
      expect(@transaction.type).to eq 'credit'
    end

    it 'stores the given amount as an accessible attribute' do
      expect(@transaction.amount).to eq '50.00'
    end

    it 'stores the given balance as an accessible attribute' do
      expect(@transaction.balance).to eq '100.00'
    end

    it 'stores the given date as an accessible attribute' do
